...
process.stdout.write(`FORKRIGHT_UNAVAILABLE_COMPLETE ${JSON.stringify({ contract, evidenceCommit, wallets: { maintainer: accounts[0].address, steward: accounts[1].address }, unavailableState, stats, transactions }, null, 2)}\n`);
